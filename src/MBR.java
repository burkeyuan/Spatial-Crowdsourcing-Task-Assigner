...
public class MBR {
   ...
   public static MBR createMBR(double centerLat, double centerLng, double rangeX, double rangeY){
       MBR mbr=new MBR(centerLat-(rangeX/2),centerLng-(rangeY/2),centerLat+(rangeX/2),centerLng+(rangeY/2));
       return mbr;
   }
}
